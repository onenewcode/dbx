...
export default withEnglishFallback({
  ...
  contextMenu: {
    ...
    createMongoIndexKeys: "索引欄位（JSON）",
    createMongoIndexKeysPlaceholder: "例如 {'{'}\"email\": 1{'}'}",
    createMongoIndexKeysHint: '複合索引會保留欄位順序；可視需要使用 1、-1、"text"、"2dsphere" 或 "hashed"。',
    createMongoIndexOptions: "選項（JSON，選填）",
    createMongoIndexOptionsPlaceholder: '例如 {\'{\'}"name": "email_1", "unique": true{\'}\'}',
    createMongoIndexOptionsHint: "可選 MongoDB 選項包括 name、unique、sparse、expireAfterSeconds、partialFilterExpression、collation 和 wildcardProjection。",
    createMongoIndexKeysRequired: "請填寫索引欄位。",
    createMongoIndexKeysInvalidJson: "索引欄位必須是有效的 JSON。",
    createMongoIndexKeysObject: "索引欄位必須是 JSON 物件。",
    createMongoIndexKeysEmpty: "索引欄位不能是空物件。",
    createMongoIndexOptionsInvalidJson: "索引選項必須是有效的 JSON。",
    createMongoIndexOptionsObject: "索引選項必須是 JSON 物件。",
    createMongoIndexOptionsNameInvalid: "索引選項「name」必須是非空字串。",
    createMongoIndexOptionsKeyReserved: "選項不能包含「key」；請在索引欄位中定義鍵。",
    ...
    mongoIndexRefreshFailed: "索引操作已完成，但無法重新整理索引清單：{message}",
