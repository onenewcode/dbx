...
export default withEnglishFallback({
  ...
  mongo: {
    ...
    export: {
      ...
      projection: "投影",
      none: "無",
      fullCollectionWarning: "未設定過濾條件：將匯出整個 Collection",
      fullDocuments: "完整文件",
      estimatedCount: "估計文件數：{count}",
      format: "格式",
      fullQueryOnly: "匯出始終寫入目前查詢的完整結果，而不是目前頁。",
      start: "匯出",
      fileFilter: "MongoDB 匯出",
      stillRunning: "匯出仍在執行。如需停止寫入，請點取消。",
      success: "已匯出 {count} 個文件到 {path}",
      progress: "已讀取 {read} 個文件 · {bytes} 位元組",
    },
    fieldEditor: "欄位",
    nativeJson: "原生 JSON",
