...
export default withEnglishFallback({
  ...
  mqMessages: {
    ...
    kafkaEarliest: "最早訊息",
    kafkaOffset: "指定分區 Offset",
    kafkaLatestHint: "從各分區末尾附近平均讀取，依時間倒序合併，結果最多 {count} 則。",
    kafkaEarliestHint: "從每個選定分區最早可讀的訊息開始正序讀取，結果最多 {count} 則。",
    kafkaOffsetHint: "從指定分區的指定 Offset 開始正序讀取，結果最多 {count} 則。",
    ...
    partitionRequiredForOffset: "以指定 Offset 讀取時必須填寫分區",
