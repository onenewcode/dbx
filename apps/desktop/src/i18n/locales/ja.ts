...
export default withEnglishFallback({
  ...
  mqMessages: {
    ...
    kafkaOffset: "指定パーティションの Offset",
    kafkaLatestHint: "各パーティションの末尾付近から均等に読み取り、タイムスタンプの新しい順に統合して最大 {count} 件を返します。",
    kafkaEarliestHint: "選択した各パーティションの先頭から昇順に読み取り、最大 {count} 件を返します。",
    kafkaOffsetHint: "指定パーティションの指定 Offset から昇順に読み取り、最大 {count} 件を返します。",
    ...
    partitionRequiredForOffset: "指定 Offset から読み取るにはパーティションが必要です",
