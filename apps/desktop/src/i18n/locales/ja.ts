...
export default withEnglishFallback({
  ...
  contextMenu: {
    ...
    createMongoIndexKeys: "キー (JSON)",
    createMongoIndexKeysPlaceholder: "例: {'{'}\"email\": 1{'}'}",
    createMongoIndexKeysHint: '複合インデックスのキー順は保持されます。必要に応じて 1、-1、"text"、"2dsphere"、"hashed" を使用します。',
    createMongoIndexOptions: "オプション (JSON、任意)",
    createMongoIndexOptionsPlaceholder: '例: {\'{\'}"name": "email_1", "unique": true{\'}\'}',
    createMongoIndexOptionsHint: "任意の MongoDB オプションには name、unique、sparse、expireAfterSeconds、partialFilterExpression、collation、wildcardProjection があります。",
    createMongoIndexKeysRequired: "インデックスキーは必須です。",
    createMongoIndexKeysInvalidJson: "インデックスキーは有効な JSON である必要があります。",
    createMongoIndexKeysObject: "インデックスキーは JSON オブジェクトである必要があります。",
    createMongoIndexKeysEmpty: "インデックスキーは空にできません。",
    createMongoIndexOptionsInvalidJson: "インデックスオプションは有効な JSON である必要があります。",
    createMongoIndexOptionsObject: "インデックスオプションは JSON オブジェクトである必要があります。",
    createMongoIndexOptionsNameInvalid: "インデックスオプション「name」は空でない文字列である必要があります。",
    createMongoIndexOptionsKeyReserved: "オプションに「key」は指定できません。インデックスのフィールドで指定してください。",
    ...
    mongoIndexRefreshFailed: "インデックス操作は完了しましたが、インデックス一覧を更新できませんでした: {message}",
