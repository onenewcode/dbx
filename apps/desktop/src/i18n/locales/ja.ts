...
export default withEnglishFallback({
  ...
  mongo: {
    ...
    export: {
      title: "クエリ結果をすべてエクスポート",
      target: "コレクション",
      filter: "フィルター",
      sort: "並べ替え",
      projection: "プロジェクション",
      none: "なし",
      fullCollectionWarning: "フィルターなし: コレクション全体がエクスポートされます",
      fullDocuments: "ドキュメント全体",
      estimatedCount: "推定ドキュメント数: {count}",
      format: "形式",
      fullQueryOnly: "エクスポートは現在のページではなく、現在のクエリの全件を書き出します。",
      start: "エクスポート",
      fileFilter: "MongoDB エクスポート",
      stillRunning: "エクスポートは実行中です。書き込みを止めるにはキャンセルしてください。",
      success: "{count} 件のドキュメントを {path} にエクスポートしました",
      progress: "{read} 件読み取り · {bytes} バイト",
    },
  },
  meilisearch: {
