...
export default withEnglishFallback({
  ...
  contextMenu: {
    ...
    createMongoIndexKeys: "索引字段（JSON）",
    createMongoIndexKeysPlaceholder: "例如 {'{'}\"email\": 1{'}'}",
    createMongoIndexKeysHint: '复合索引会保留字段顺序；可按需使用 1、-1、"text"、"2dsphere" 或 "hashed"。',
    createMongoIndexOptions: "选项（JSON，可选）",
    createMongoIndexOptionsPlaceholder: '例如 {\'{\'}"name": "email_1", "unique": true{\'}\'}',
    createMongoIndexOptionsHint: "可选 MongoDB 选项包括 name、unique、sparse、expireAfterSeconds、partialFilterExpression、collation 和 wildcardProjection。",
    createMongoIndexKeysRequired: "请填写索引字段。",
    createMongoIndexKeysInvalidJson: "索引字段必须是有效的 JSON。",
    createMongoIndexKeysObject: "索引字段必须是 JSON 对象。",
    createMongoIndexKeysEmpty: "索引字段不能是空对象。",
    createMongoIndexOptionsInvalidJson: "索引选项必须是有效的 JSON。",
    createMongoIndexOptionsObject: "索引选项必须是 JSON 对象。",
    createMongoIndexOptionsNameInvalid: "索引选项“name”必须是非空字符串。",
    createMongoIndexOptionsKeyReserved: "选项不能包含“key”；请在索引字段中定义键。",
    dropForeignKey: "删除外键",
    dropTrigger: "删除触发器",
    ...
    mongoIndexRefreshFailed: "索引操作已完成，但无法刷新索引列表：{message}",
