...
export default withEnglishFallback({
  ...
  mongo: {
    ...
    export: {
      ...
      projection: "投影",
      none: "无",
      fullCollectionWarning: "未设置过滤条件：将导出整个 Collection",
      fullDocuments: "完整文档",
      estimatedCount: "估计文档数：{count}",
      format: "格式",
      fullQueryOnly: "导出始终写入当前查询的完整结果，而不是当前页。",
      start: "导出",
      fileFilter: "MongoDB 导出",
      stillRunning: "导出仍在运行。如需停止写入，请点取消。",
      success: "已导出 {count} 个文档到 {path}",
      progress: "已读取 {read} 个文档 · {bytes} 字节",
    },
  },
  meilisearch: {
