...
export default withEnglishFallback({
  ...
  mqMessages: {
    ...
    kafkaEarliest: "最早消息",
    kafkaOffset: "指定分区 Offset",
    kafkaLatestHint: "从各分区末尾附近均衡读取，按时间倒序合并，结果最多 {count} 条。",
    kafkaEarliestHint: "从每个选定分区的最早可读消息开始正序读取，结果最多 {count} 条。",
    kafkaOffsetHint: "从指定分区的指定 Offset 开始正序读取，结果最多 {count} 条。",
    ...
    partitionRequiredForOffset: "按指定 Offset 读取时必须填写分区",
