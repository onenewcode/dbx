...
export default withEnglishFallback({
  ...
  mqMessages: {
    ...
    kafkaOffset: "Offset di una partizione",
    kafkaLatestHint: "Legge una finestra bilanciata vicino alla fine di ogni partizione, unisce per timestamp con i più recenti prima e restituisce al massimo {count} messaggi.",
    kafkaEarliestHint: "Legge la cronologia in avanti da ogni partizione selezionata e restituisce al massimo {count} messaggi.",
    kafkaOffsetHint: "Legge in avanti dall'offset indicato in una partizione e restituisce al massimo {count} messaggi.",
    ...
    partitionRequiredForOffset: "Per leggere da un offset specifico è richiesta una partizione",
