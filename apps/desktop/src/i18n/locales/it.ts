...
export default withEnglishFallback({
  ...
  contextMenu: {
    ...
    createMongoIndexKeys: "Chiavi (JSON)",
    createMongoIndexKeysPlaceholder: "ad es. {'{'}\"email\": 1{'}'}",
    createMongoIndexKeysHint: 'L\'ordine delle chiavi degli indici composti viene mantenuto. Usa 1, -1, "text", "2dsphere" o "hashed" quando necessario.',
    createMongoIndexOptions: "Opzioni (JSON, facoltativo)",
    createMongoIndexOptionsPlaceholder: 'ad es. {\'{\'}"name": "email_1", "unique": true{\'}\'}',
    createMongoIndexOptionsHint: "Le opzioni MongoDB facoltative includono name, unique, sparse, expireAfterSeconds, partialFilterExpression, collation e wildcardProjection.",
    createMongoIndexKeysRequired: "Le chiavi dell'indice sono obbligatorie.",
    createMongoIndexKeysInvalidJson: "Le chiavi dell'indice devono essere JSON valido.",
    createMongoIndexKeysObject: "Le chiavi dell'indice devono essere un oggetto JSON.",
    createMongoIndexKeysEmpty: "Le chiavi dell'indice non possono essere vuote.",
    createMongoIndexOptionsInvalidJson: "Le opzioni dell'indice devono essere JSON valido.",
    createMongoIndexOptionsObject: "Le opzioni dell'indice devono essere un oggetto JSON.",
    createMongoIndexOptionsNameInvalid: "L'opzione dell'indice \"name\" deve essere una stringa non vuota.",
    createMongoIndexOptionsKeyReserved: 'Le opzioni non possono contenere "key"; definisci separatamente i campi dell\'indice.',
    ...
    mongoIndexRefreshFailed: "L'operazione sull'indice è riuscita, ma non è stato possibile aggiornare l'elenco degli indici: {message}",
