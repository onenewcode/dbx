...
export default withEnglishFallback({
  ...
  mongo: {
    ...
    export: {
      title: "Esporta il risultato completo della query",
      target: "Collezione",
      filter: "Filtro",
      sort: "Ordinamento",
      projection: "Proiezione",
      none: "Nessuno",
      fullCollectionWarning: "Nessun filtro: verrà esportata l'intera collezione",
      fullDocuments: "Documenti completi",
      estimatedCount: "Documenti stimati: {count}",
      format: "Formato",
      fullQueryOnly: "L'esportazione scrive il risultato completo della query corrente, non la pagina corrente.",
      start: "Esporta",
      fileFilter: "Esportazione MongoDB",
      stillRunning: "L'esportazione è ancora in esecuzione. Usa Annulla per fermare la scrittura.",
      success: "Esportati {count} documenti in {path}",
      progress: "Letti {read} documenti · {bytes} byte",
    },
  },
  meilisearch: {
