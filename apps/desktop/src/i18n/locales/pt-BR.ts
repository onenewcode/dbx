...
export default withEnglishFallback({
  ...
  mqMessages: {
    ...
    kafkaOffsetHint: "Lê em ordem crescente a partir do offset informado na partição escolhida, ou em todas se deixada vazia, e retorna no máximo {count} mensagens.",
