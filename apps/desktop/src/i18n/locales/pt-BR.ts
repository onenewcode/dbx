...
export default withEnglishFallback({
  ...
  contextMenu: {
    ...
    createMongoIndexKeys: "Chaves (JSON)",
    createMongoIndexKeysPlaceholder: "ex.: {'{'}\"email\": 1{'}'}",
    createMongoIndexKeysHint: 'A ordem das chaves de índices compostos é preservada. Use 1, -1, "text", "2dsphere" ou "hashed" conforme necessário.',
    createMongoIndexOptions: "Opções (JSON, opcional)",
    createMongoIndexOptionsPlaceholder: 'ex.: {\'{\'}"name": "email_1", "unique": true{\'}\'}',
    createMongoIndexOptionsHint: "As opções opcionais do MongoDB incluem name, unique, sparse, expireAfterSeconds, partialFilterExpression, collation e wildcardProjection.",
    createMongoIndexKeysRequired: "As chaves do índice são obrigatórias.",
    createMongoIndexKeysInvalidJson: "As chaves do índice devem ser JSON válido.",
    createMongoIndexKeysObject: "As chaves do índice devem ser um objeto JSON.",
    createMongoIndexKeysEmpty: "As chaves do índice não podem estar vazias.",
    createMongoIndexOptionsInvalidJson: "As opções do índice devem ser JSON válido.",
    createMongoIndexOptionsObject: "As opções do índice devem ser um objeto JSON.",
    createMongoIndexOptionsNameInvalid: 'A opção de índice "name" deve ser uma string não vazia.',
    createMongoIndexOptionsKeyReserved: 'As opções não podem conter "key"; defina os campos do índice separadamente.',
    ...
    mongoIndexRefreshFailed: "A operação de índice foi concluída, mas não foi possível atualizar a lista de índices: {message}",
