...
export default withEnglishFallback({
  ...
  mongo: {
    ...
    export: {
      title: "Exportar o resultado completo da consulta",
      target: "Coleção",
      filter: "Filtro",
      sort: "Ordenação",
      projection: "Projeção",
      none: "Nenhum",
      fullCollectionWarning: "Sem filtro: a coleção inteira será exportada",
      fullDocuments: "Documentos completos",
      estimatedCount: "Documentos estimados: {count}",
      format: "Formato",
      fullQueryOnly: "A exportação grava o resultado completo da consulta atual, não a página atual.",
      start: "Exportar",
      fileFilter: "Exportação do MongoDB",
      stillRunning: "A exportação ainda está em execução. Use Cancelar para interromper a gravação.",
      success: "{count} documentos exportados para {path}",
      progress: "{read} documentos lidos · {bytes} bytes",
    },
  },
  meilisearch: {
