...
export default withEnglishFallback({
  ...
  mqMessages: {
    ...
    kafkaOffset: "Offset de uma partição",
    kafkaLatestHint: "Lê uma janela equilibrada perto do fim de cada partição, mescla por data e hora com as mais novas primeiro e retorna no máximo {count} mensagens.",
    kafkaEarliestHint: "Lê o histórico em ordem crescente de cada partição selecionada e retorna no máximo {count} mensagens.",
    kafkaOffsetHint: "Lê em ordem crescente a partir do offset informado em uma partição e retorna no máximo {count} mensagens.",
    ...
    partitionRequiredForOffset: "Uma partição é obrigatória para ler de um offset específico",
