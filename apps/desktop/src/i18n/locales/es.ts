...
export default withEnglishFallback({
  ...
  mongo: {
    ...
    export: {
      title: "Exportar el resultado completo de la consulta",
      target: "Colección",
      filter: "Filtro",
      sort: "Orden",
      projection: "Proyección",
      none: "Ninguno",
      fullCollectionWarning: "Sin filtro: se exportará toda la colección",
      fullDocuments: "Documentos completos",
      estimatedCount: "Documentos estimados: {count}",
      format: "Formato",
      fullQueryOnly: "La exportación escribe el resultado completo de la consulta actual, no la página actual.",
      start: "Exportar",
      fileFilter: "Exportación de MongoDB",
      stillRunning: "La exportación sigue en curso. Use Cancelar para detener la escritura.",
      success: "Se exportaron {count} documentos a {path}",
      progress: "Leídos {read} documentos · {bytes} bytes",
    },
  },
  meilisearch: {
