...
export default withEnglishFallback({
  ...
  contextMenu: {
    ...
    createMongoIndexKeys: "Claves (JSON)",
    createMongoIndexKeysPlaceholder: "p. ej. {'{'}\"email\": 1{'}'}",
    createMongoIndexKeysHint: 'Se conserva el orden de las claves de los índices compuestos. Use 1, -1, "text", "2dsphere" o "hashed" según sea necesario.',
    createMongoIndexOptions: "Opciones (JSON, opcional)",
    createMongoIndexOptionsPlaceholder: 'p. ej. {\'{\'}"name": "email_1", "unique": true{\'}\'}',
    createMongoIndexOptionsHint: "Las opciones opcionales de MongoDB incluyen name, unique, sparse, expireAfterSeconds, partialFilterExpression, collation y wildcardProjection.",
    createMongoIndexKeysRequired: "Se requieren las claves del índice.",
    createMongoIndexKeysInvalidJson: "Las claves del índice deben ser JSON válido.",
    createMongoIndexKeysObject: "Las claves del índice deben ser un objeto JSON.",
    createMongoIndexKeysEmpty: "Las claves del índice no pueden estar vacías.",
    createMongoIndexOptionsInvalidJson: "Las opciones del índice deben ser JSON válido.",
    createMongoIndexOptionsObject: "Las opciones del índice deben ser un objeto JSON.",
    createMongoIndexOptionsNameInvalid: 'La opción de índice "name" debe ser una cadena no vacía.',
    createMongoIndexOptionsKeyReserved: 'Las opciones no pueden contener "key"; define los campos del índice por separado.',
    ...
    mongoIndexRefreshFailed: "La operación de índice se completó, pero no se pudo actualizar la lista de índices: {message}",
