...
export default withEnglishFallback({
  ...
  mqMessages: {
    ...
    kafkaOffset: "Offset de una partición",
    kafkaLatestHint: "Lee una ventana equilibrada cerca del final de cada partición, combina por marca de tiempo con los más nuevos primero y devuelve como máximo {count} mensajes.",
    kafkaEarliestHint: "Lee el historial hacia adelante desde cada partición seleccionada y devuelve como máximo {count} mensajes.",
    kafkaOffsetHint: "Lee hacia adelante desde el offset indicado de una partición y devuelve como máximo {count} mensajes.",
    ...
    partitionRequiredForOffset: "Se requiere una partición para leer desde un offset específico",
