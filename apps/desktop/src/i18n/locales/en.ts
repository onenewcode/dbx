export default {
  ...
  contextMenu: {
    ...
    createMongoIndexKeys: "Keys (JSON)",
    createMongoIndexKeysPlaceholder: "e.g. {'{'}\"email\": 1{'}'}",
    createMongoIndexKeysHint: 'Compound-index key order is preserved. Use 1, -1, "text", "2dsphere", or "hashed" as needed.',
    createMongoIndexOptions: "Options (JSON, optional)",
    createMongoIndexOptionsPlaceholder: 'e.g. {\'{\'}"name": "email_1", "unique": true{\'}\'}',
    createMongoIndexOptionsHint: "Optional MongoDB options include name, unique, sparse, expireAfterSeconds, partialFilterExpression, collation, and wildcardProjection.",
    createMongoIndexKeysRequired: "Index keys are required.",
    createMongoIndexKeysInvalidJson: "Index keys must be valid JSON.",
    createMongoIndexKeysObject: "Index keys must be a JSON object.",
    createMongoIndexKeysEmpty: "Index keys must not be empty.",
    createMongoIndexOptionsInvalidJson: "Index options must be valid JSON.",
    createMongoIndexOptionsObject: "Index options must be a JSON object.",
    createMongoIndexOptionsNameInvalid: 'Index option "name" must be a non-empty string.',
    createMongoIndexOptionsKeyReserved: 'Index options cannot contain "key"; define index fields separately.',
    ...
    mongoIndexRefreshFailed: "The index change succeeded, but the index list could not be refreshed: {message}",
