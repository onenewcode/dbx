export default {
  ...
  mqMessages: {
    ...
    kafkaOffset: "Specific partition offset",
    kafkaLatestHint: "Reads a balanced window near the end of each partition, merges by timestamp newest first, and returns at most {count} messages.",
    kafkaEarliestHint: "Reads history forward from each selected partition and returns at most {count} messages.",
    kafkaOffsetHint: "Reads forward from the specified offset in one partition and returns at most {count} messages.",
    ...
    partitionRequiredForOffset: "A partition is required when reading from a specific offset",
