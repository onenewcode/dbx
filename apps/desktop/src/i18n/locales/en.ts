...
export default {
  ...
  mongo: {
    ...
    export: {
      title: "Export full query results",
      target: "Collection",
      filter: "Filter",
      sort: "Sort",
      projection: "Projection",
      none: "None",
      fullCollectionWarning: "No filter: the entire collection will be exported",
      fullDocuments: "Full documents",
      estimatedCount: "Estimated documents: {count}",
      format: "Format",
      fullQueryOnly: "Export always writes the current query’s complete result, not the current page.",
      start: "Export",
      fileFilter: "MongoDB export",
      stillRunning: "Export is still running. Use Cancel to stop writing.",
      success: "Exported {count} documents to {path}",
      progress: "Read {read} documents · {bytes} bytes",
    },
  },
  meilisearch: {
